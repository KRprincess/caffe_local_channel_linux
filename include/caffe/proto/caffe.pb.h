...
class ConvolutionParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional bool force_local_channel = 19 [default = false];
  inline bool has_force_local_channel() const;
  inline void clear_force_local_channel();
  static const int kForceLocalChannelFieldNumber = 19;
  inline bool force_local_channel() const;
  inline void set_force_local_channel(bool value);

  // optional uint32 pad_c = 20 [default = 0];
  inline bool has_pad_c() const;
  inline void clear_pad_c();
  static const int kPadCFieldNumber = 20;
  inline ::google::protobuf::uint32 pad_c() const;
  inline void set_pad_c(::google::protobuf::uint32 value);

  // optional uint32 kernel_c = 21;
  inline bool has_kernel_c() const;
  inline void clear_kernel_c();
  static const int kKernelCFieldNumber = 21;
  inline ::google::protobuf::uint32 kernel_c() const;
  inline void set_kernel_c(::google::protobuf::uint32 value);

  // optional uint32 stride_c = 22;
  inline bool has_stride_c() const;
  inline void clear_stride_c();
  static const int kStrideCFieldNumber = 22;
  inline ::google::protobuf::uint32 stride_c() const;
  inline void set_stride_c(::google::protobuf::uint32 value);

  // optional uint32 num_output_per_group = 23 [default = 1];
  inline bool has_num_output_per_group() const;
  inline void clear_num_output_per_group();
  static const int kNumOutputPerGroupFieldNumber = 23;
  inline ::google::protobuf::uint32 num_output_per_group() const;
  inline void set_num_output_per_group(::google::protobuf::uint32 value);

  // optional bool share_weights_per_round = 24 [default = false];
  inline bool has_share_weights_per_round() const;
  inline void clear_share_weights_per_round();
  static const int kShareWeightsPerRoundFieldNumber = 24;
  inline bool share_weights_per_round() const;
  inline void set_share_weights_per_round(bool value);
 ...
 private:
  ...
  inline void set_has_force_local_channel();
  inline void clear_has_force_local_channel();
  inline void set_has_pad_c();
  inline void clear_has_pad_c();
  inline void set_has_kernel_c();
  inline void clear_has_kernel_c();
  inline void set_has_stride_c();
  inline void clear_has_stride_c();
  inline void set_has_num_output_per_group();
  inline void clear_has_num_output_per_group();
  inline void set_has_share_weights_per_round();
  inline void clear_has_share_weights_per_round();
  ...
  ::google::protobuf::uint32 pad_c_;
  ::google::protobuf::uint32 kernel_c_;
  ::google::protobuf::uint32 stride_c_;
  ::caffe::FillerParameter* weight_filler_;
  ::google::protobuf::uint32 num_output_per_group_;
  int engine_;
...
// optional bool force_local_channel = 19 [default = false];
inline bool ConvolutionParameter::has_force_local_channel() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void ConvolutionParameter::set_has_force_local_channel() {
  _has_bits_[0] |= 0x00002000u;
}
inline void ConvolutionParameter::clear_has_force_local_channel() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void ConvolutionParameter::clear_force_local_channel() {
  force_local_channel_ = false;
  clear_has_force_local_channel();
}
inline bool ConvolutionParameter::force_local_channel() const {
  // @@protoc_insertion_point(field_get:caffe.ConvolutionParameter.force_local_channel)
  return force_local_channel_;
}
inline void ConvolutionParameter::set_force_local_channel(bool value) {
  set_has_force_local_channel();
  force_local_channel_ = value;
  // @@protoc_insertion_point(field_set:caffe.ConvolutionParameter.force_local_channel)
}

// optional uint32 pad_c = 20 [default = 0];
inline bool ConvolutionParameter::has_pad_c() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void ConvolutionParameter::set_has_pad_c() {
  _has_bits_[0] |= 0x00004000u;
}
inline void ConvolutionParameter::clear_has_pad_c() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void ConvolutionParameter::clear_pad_c() {
  pad_c_ = 0u;
  clear_has_pad_c();
}
inline ::google::protobuf::uint32 ConvolutionParameter::pad_c() const {
  // @@protoc_insertion_point(field_get:caffe.ConvolutionParameter.pad_c)
  return pad_c_;
}
inline void ConvolutionParameter::set_pad_c(::google::protobuf::uint32 value) {
  set_has_pad_c();
  pad_c_ = value;
  // @@protoc_insertion_point(field_set:caffe.ConvolutionParameter.pad_c)
}

// optional uint32 kernel_c = 21;
inline bool ConvolutionParameter::has_kernel_c() const {
  return (_has_bits_[0] & 0x00008000u) != 0;
}
inline void ConvolutionParameter::set_has_kernel_c() {
  _has_bits_[0] |= 0x00008000u;
}
inline void ConvolutionParameter::clear_has_kernel_c() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void ConvolutionParameter::clear_kernel_c() {
  kernel_c_ = 0u;
  clear_has_kernel_c();
}
inline ::google::protobuf::uint32 ConvolutionParameter::kernel_c() const {
  // @@protoc_insertion_point(field_get:caffe.ConvolutionParameter.kernel_c)
  return kernel_c_;
}
inline void ConvolutionParameter::set_kernel_c(::google::protobuf::uint32 value) {
  set_has_kernel_c();
  kernel_c_ = value;
  // @@protoc_insertion_point(field_set:caffe.ConvolutionParameter.kernel_c)
}

// optional uint32 stride_c = 22;
inline bool ConvolutionParameter::has_stride_c() const {
  return (_has_bits_[0] & 0x00010000u) != 0;
}
inline void ConvolutionParameter::set_has_stride_c() {
  _has_bits_[0] |= 0x00010000u;
}
inline void ConvolutionParameter::clear_has_stride_c() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void ConvolutionParameter::clear_stride_c() {
  stride_c_ = 0u;
  clear_has_stride_c();
}
inline ::google::protobuf::uint32 ConvolutionParameter::stride_c() const {
  // @@protoc_insertion_point(field_get:caffe.ConvolutionParameter.stride_c)
  return stride_c_;
}
inline void ConvolutionParameter::set_stride_c(::google::protobuf::uint32 value) {
  set_has_stride_c();
  stride_c_ = value;
  // @@protoc_insertion_point(field_set:caffe.ConvolutionParameter.stride_c)
}

// optional uint32 num_output_per_group = 23 [default = 1];
inline bool ConvolutionParameter::has_num_output_per_group() const {
  return (_has_bits_[0] & 0x00020000u) != 0;
}
inline void ConvolutionParameter::set_has_num_output_per_group() {
  _has_bits_[0] |= 0x00020000u;
}
inline void ConvolutionParameter::clear_has_num_output_per_group() {
  _has_bits_[0] &= ~0x00020000u;
}
inline void ConvolutionParameter::clear_num_output_per_group() {
  num_output_per_group_ = 1u;
  clear_has_num_output_per_group();
}
inline ::google::protobuf::uint32 ConvolutionParameter::num_output_per_group() const {
  // @@protoc_insertion_point(field_get:caffe.ConvolutionParameter.num_output_per_group)
  return num_output_per_group_;
}
inline void ConvolutionParameter::set_num_output_per_group(::google::protobuf::uint32 value) {
  set_has_num_output_per_group();
  num_output_per_group_ = value;
  // @@protoc_insertion_point(field_set:caffe.ConvolutionParameter.num_output_per_group)
}

// optional bool share_weights_per_round = 24 [default = false];
inline bool ConvolutionParameter::has_share_weights_per_round() const {
  return (_has_bits_[0] & 0x00040000u) != 0;
}
inline void ConvolutionParameter::set_has_share_weights_per_round() {
  _has_bits_[0] |= 0x00040000u;
}
inline void ConvolutionParameter::clear_has_share_weights_per_round() {
  _has_bits_[0] &= ~0x00040000u;
}
inline void ConvolutionParameter::clear_share_weights_per_round() {
  share_weights_per_round_ = false;
  clear_has_share_weights_per_round();
}
inline bool ConvolutionParameter::share_weights_per_round() const {
  // @@protoc_insertion_point(field_get:caffe.ConvolutionParameter.share_weights_per_round)
  return share_weights_per_round_;
}
inline void ConvolutionParameter::set_share_weights_per_round(bool value) {
  set_has_share_weights_per_round();
  share_weights_per_round_ = value;
  // @@protoc_insertion_point(field_set:caffe.ConvolutionParameter.share_weights_per_round)
}
